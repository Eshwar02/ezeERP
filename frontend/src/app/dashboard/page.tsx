...
export default function DashboardPage() {
  return (
    <Shell title="Gateway of SmartERP">
          ...
          <ul className="grid grid-cols-2 gap-2">
            {modules.map((module) => (
              <li key={module.label}>
                <Link
                  href={module.href}
                  className="block rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:border-brand-green hover:bg-brand-green/10 hover:text-brand-greenDark"
                >
                  {module.label}
                </Link>
              </li>
